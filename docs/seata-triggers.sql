...
DELIMITER $$
CREATE DEFINER=`root`@`127.0.0.1` TRIGGER `branch_table_AFTER_INSERT` AFTER INSERT ON `branch_table` FOR EACH ROW
BEGIN
...
DELIMITER $$
CREATE DEFINER=`root`@`127.0.0.1` TRIGGER `branch_table_AFTER_UPDATE` AFTER UPDATE ON `branch_table` FOR EACH ROW
BEGIN
...
DELIMITER $$
CREATE DEFINER=`root`@`127.0.0.1` TRIGGER `branch_table_AFTER_DELETE` AFTER DELETE ON `branch_table` FOR EACH ROW
BEGIN
...
DELIMITER $$
CREATE DEFINER=`root`@`127.0.0.1` TRIGGER `global_table_AFTER_INSERT` AFTER INSERT ON `global_table` FOR EACH ROW
BEGIN
...
DELIMITER $$
CREATE DEFINER=`root`@`127.0.0.1` TRIGGER `global_table_AFTER_UPDATE` AFTER UPDATE ON `global_table` FOR EACH ROW
BEGIN
...
DELIMITER $$
CREATE DEFINER=`root`@`127.0.0.1` TRIGGER `global_table_AFTER_DELETE` AFTER DELETE ON `global_table` FOR EACH ROW
BEGIN
...
DELIMITER $$
CREATE DEFINER=`root`@`127.0.0.1` TRIGGER `lock_table_AFTER_INSERT` AFTER INSERT ON `lock_table` FOR EACH ROW
BEGIN 
...
DELIMITER $$
CREATE DEFINER=`root`@`127.0.0.1` TRIGGER `lock_table_AFTER_DELETE` AFTER DELETE ON `lock_table` FOR EACH ROW
BEGIN
